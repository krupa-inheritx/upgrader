...
class Upgrader {
    ...
    if (!_displayed) {
      ...
      if (shouldDisplay) {
        ...
        Future.delayed(const Duration(milliseconds: 0), () {
          _showDialog(
              context: context,
              title: 'Tadaah App', // messages.message(UpgraderMessage.title),
              message: 'New app version available!', //message(),
  ...
  showUpdateDialog({required BuildContext context}) {
    _showDialog(
      context: context,
      title: 'Tadaah App', // messages.message(UpgraderMessage.title),
      message: 'New app version available!', //message(),
      ...
      builder: (BuildContext context) {
        return WillPopScope(
          ...
          child: dialogStyle == UpgradeDialogStyle.material
              ? _alertDialog(
                  title!, message, releaseNotes, context, canDismissDialog)
  ...
  AlertDialog _alertDialog(String title, String message, String? releaseNotes,
      BuildContext context, bool? canDismissDialog) {
    Widget? notes;
  ...
  CupertinoAlertDialog _cupertinoAlertDialog(String title, String message,
      String? releaseNotes, BuildContext context, bool? canDismissDialog) {
    Widget? notes;
    if (releaseNotes != null) {
      notes = Padding(
          padding: const EdgeInsets.only(top: 15.0),
